...
export const TALUKAS = [
  { name: 'Wardha', mr: 'वर्धा', lat: 20.745, lon: 78.602 },
  { name: 'Deoli', mr: 'देवळी', lat: 20.648, lon: 78.481 },
  { name: 'Seloo', mr: 'सेलू', lat: 20.846, lon: 78.715 },
  { name: 'Arvi', mr: 'आर्वी', lat: 20.99, lon: 78.227 },
  { name: 'Ashti', mr: 'आष्टी', lat: 21.203, lon: 78.186 },
  { name: 'Karanja', mr: 'कारंजा', lat: 21.123, lon: 78.4 },
  { name: 'Hinganghat', mr: 'हिंगणघाट', lat: 20.548, lon: 78.839 },
  { name: 'Samudrapur', mr: 'समुद्रपूर', lat: 20.65, lon: 78.97 }
];

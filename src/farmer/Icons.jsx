...
export const MapIcon = ({ s = 20 }) => (<svg width={s} height={s} viewBox="0 0 24 24" {...P}><path d="M14.1 4.1 9.9 2.3a2 2 0 0 0-1.6 0L3.6 4.4A1 1 0 0 0 3 5.3v14.2a1 1 0 0 0 1.4.9l3.9-1.8a2 2 0 0 1 1.6 0l4.2 1.8a2 2 0 0 0 1.6 0l4.7-2.1a1 1 0 0 0 .6-.9V3.2a1 1 0 0 0-1.4-.9l-3.9 1.8a2 2 0 0 1-1.6 0Z" /><path d="M15 5.8v15" /><path d="M9 3.2v15" /></svg>);
export const Users = ({ s = 16 }) => (<svg width={s} height={s} viewBox="0 0 24 24" {...P}><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>);

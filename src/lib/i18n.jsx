...
const S = {
  ...
  credits: { en: 'About & data credits', mr: 'माहिती व डेटा श्रेय' },
  day: { en: 'Day', mr: 'दिवस' },
  ...
  perLitreSpot: { en: 'per litre, spot drench', mr: 'प्रति लिटर, आळवणी' },
  ...
  cropNoModel: { en: 'Photo diagnosis works for cotton, soybean, chickpea and sugarcane now. {c} is coming next.', mr: 'फोटो निदान सध्या कापूस, सोयाबीन, हरभरा आणि उसासाठी आहे. {c} लवकरच.' },
  demoModel: { en: 'Demo mode: the disease model for this crop has not loaded, so results are simulated.', mr: 'डेमो: या पिकाचे मॉडेल लोड झाले नाही, निकाल उदाहरणादाखल आहेत.' },
